...
final class HuffmanCompressionTableBb {
    final short[] values;
    ...
    static int compressWeights(
        ...
        int tableLog = FiniteStateEntropyBb.optimalTableLog(MAX_FSE_TABLE_LOG, weightsLength, maxSymbol);
        FiniteStateEntropyBb.normalizeCounts(normalizedCounts, tableLog, counts, weightsLength, maxSymbol);

        int output = outputAddress;
        int outputLimit = outputAddress + outputSize;

        // Write table description header
        int headerSize = FiniteStateEntropyBb.writeNormalizedCounts(
                outputBase,
                output,
                outputSize,
                normalizedCounts,
        ...
        int compressedSize = FiniteStateEntropyBb.compress(
                outputBase,
                output,
