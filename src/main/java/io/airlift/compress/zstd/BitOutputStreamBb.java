...
class BitOutputStreamBb extends BitOutputStream
{
    ...
    private final ByteBuffer outputBase;
    ...
    public BitOutputStreamBb(ByteBuffer outputBase, int outputAddress, int outputSize)
    {
        super(outputBase, outputAddress, outputSize);
