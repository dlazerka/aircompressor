...
class FiniteStateEntropyBb {
    ...
    public static int decompress(
        ...
        final ByteBuffer outputBase = outputBuffer;
        // final long outputAddress = ARRAY_BYTE_BASE_OFFSET;
        final int outputAddress = 0;
        final int outputLimit = outputBuffer.remaining();

        int input = inputAddress;
        int output = outputAddress;

        // initialize bit stream
        BitInputStreamBb.Initializer initializer = new BitInputStreamBb.Initializer(inputBase, input, inputLimit);
        ...
        BitInputStreamBb.Loader loader = new BitInputStreamBb.Loader(inputBase, input, currentAddress, bits, bitsConsumed);
        loader.load();
        bits = loader.getBits();
        ...
        loader = new BitInputStreamBb.Loader(inputBase, input, currentAddress, bits, bitsConsumed);
        loader.load();
        bits = loader.getBits();
        bitsConsumed = loader.getBitsConsumed();
        currentAddress = loader.getCurrentAddress();
    ...
    public static int compress(
        ...
        BitOutputStreamBb stream = new BitOutputStreamBb(outputBase, outputAddress, outputSize);
        ...
        if ((inputSize & 1) != 0) {
            ...
            // state1 = table.begin(inputBase.get(input));
    ...
    private static int normalizeCounts2(
    ...
    public static int writeNormalizedCounts(
            ByteBuffer outputBase,
            int outputAddress,
            int outputSize,
            short[] normalizedCounts,
