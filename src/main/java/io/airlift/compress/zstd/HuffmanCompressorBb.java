...
class HuffmanCompressorBb {
    private HuffmanCompressorBb() {
    }

    public static int compress4streams(
        ...
        // first segment
        compressedSize = compressSingleStream(
                outputBase,
                output,
                outputLimit - output,
                inputBase,
    ...
    public static int compressSingleStream(
            ByteBuffer outputBase,
            int outputAddress,
            int outputSize,
            byte[] inputBase,
        ...
        BitOutputStreamBb bitstream = new BitOutputStreamBb(outputBase, outputAddress, outputSize);
        int input = inputAddress;
