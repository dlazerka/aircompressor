 ...
 */
class BitInputStreamBb
{
    private BitInputStreamBb()
    {
    }
    ...
    static long readTail(ByteBuffer inputBase, int inputAddress, int inputSize)
    {
    ...
    static class Initializer
    {
        ...
        public Initializer(ByteBuffer inputBase, int startAddress, int endAddress)
        {
        ...
        public void initialize()
        {
            ...
            int lastByte = inputBase.get(endAddress - 1) & 0xFF;
    ...
    static final class Loader
    {
        ...
        public Loader(ByteBuffer inputBase, int startAddress, int currentAddress, long bits, int bitsConsumed)
        {
            this.inputBase = inputBase;
            this.startAddress = startAddress;
            this.bits = bits;
